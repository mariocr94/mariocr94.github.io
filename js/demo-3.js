(function() {
    ...
    var colors = ['85,107,47', '46,139,87', '66,152,103', '128,128,128', '0,100,0'];
    ...
    function tweenTriangle(tri) {
        ...
        var x = (350+Math.random()*100)*Math.cos(t) + width*0.5;
        var y = (350+Math.random()*100)*Math.sin(t) + height*0.5-20;
